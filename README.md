...
| ارسال پیام پشتیبانی خطای ۵۰۳ می‌دهد | حداقل باید یک حساب ادمین (`is_superuser=True`) در سیستم وجود داشته باشد؛ کافیست `python manage.py createsuperuser` را اجرا کرده باشید. |
