...
export default function Residence() {
    ...
    const renderCultureTab = () => (
        <div className="space-y-4">
            ...
            <p className="text-xs text-ink-500 text-center">
                با برگزاری جشن در تالار شهر امتیاز فرهنگی کسب کنید. امتیاز فرهنگی برای گسترش قلمرو ضروری است.
            </p>
        </div>
    );
    ...
    const renderLoyaltyTab = () => (
        <div className="space-y-4">
            <div className="bg-parchment-50 rounded-xl p-4 border border-parchment-300 text-center">
                ...
                <p className="text-xs text-ink-500 mt-3">وفاداری خودکار بازیابی می‌شود. اقامتگاه سرعت بازیابی را افزایش می‌دهد.</p>
            </div>
        </div>
    );
    ...
    return (
        <PageShell maxWidth="max-w-3xl">
            <AlertModal open={!!alertMsg} onClose={() => setAlertMsg(null)} tone={alertMsg?.tone} message={alertMsg?.text} title="اقامتگاه" />

            <WoodSign title={data.building_name || 'اقامتگاه'} icon="🏰">
