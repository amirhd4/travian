                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-2">
                    {data.packages.map((pkg) => (
                        <div key={pkg.id} className="bg-white border-2 border-parchment-300 rounded-xl p-4 text-center shadow-soft hover:border-gold-400 transition">
                            <img src="/assets/ui/gold-icon.gif" alt="طلا" className="w-12 h-12 mx-auto mb-1" onError={(e) => { e.target.style.display='none'; e.target.nextSibling.style.display='block'; }} />
